...
const { movie_characteristics } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('movie_characteristics');

// This file contains the logic of every route in Forest Admin for the collection movie_characteristics:
...
router.post('/movie_characteristics', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/movie_characteristics/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/movie_characteristics/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/movie_characteristics', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/movie_characteristics/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/movie_characteristics/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/movie_characteristics.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
