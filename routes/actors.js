...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('actors');

// This file contains the logic of every route in Forest Admin for the collection actors:
...
// Create a Actor
router.post('/actors', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Actor
router.put('/actors/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Actor
router.delete('/actors/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/actors', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Actors
router.get('/actors/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Actor
router.get('/actors/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Actors
router.get('/actors.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
