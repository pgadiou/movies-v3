...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('roles');

// This file contains the logic of every route in Forest Admin for the collection roles:
...
// Update a Role
router.put('/roles/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Role
router.delete('/roles/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Roles
router.get('/roles', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Roles
router.get('/roles/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Role
router.get('/roles/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/roles.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
